...
local testBlock = newmoon.copytable(testmod.testblock)
local leftChest = newmoon.copytable(testmod.testchest)
local leftChestInv = newmoon.api.inventory.get(leftChest)
local rightChest = newmoon.copytable(testmod.testchest)
